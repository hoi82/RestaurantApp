    ...
    return (
        <div className={styles.takeout_result}>
            <div className={styles.title_box}>
                ...
                <svg ref={menuRef} className={styles.menu} enableBackground="new 0 0 512 512" height="512" viewBox="0 0 512 512" width="512" xmlns="http://www.w3.org/2000/svg">
                ...
                <Popup trigger={menuRef} position={{top: "48px", right: 0}}>
