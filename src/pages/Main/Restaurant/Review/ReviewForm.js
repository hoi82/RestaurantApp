...
import { uploadReview } from '../../../../actions/main/restaurant/review'; 

export default ({route, match, review}) => {                
    ...
    const handleReviewSubmit = (values) => {        
        if (match.path == endpoint.newReview) {
            console.log("new");
        }
        else if (match.path == endpoint.editReview) {
            console.log("edit");
        }
    }
    ...
    return ( 
        <Formik initialValues={isEdit ? review : {rating: 0, title: "", comment: ""}} validateOnChange={false} onSubmit={handleReviewSubmit} enableReinitialize={true}>
                        ...
                        {({
                            ...
                            <div>
                                <div className={styles.header_box}>
                                    ...
                                    <span className={styles.error_title.concat(" ", styles.error_visible)}>{errors.rating}</span>
                                </div>
                                <Ratings rating={field.value} changeRating={(value) => {setFieldValue("rating", value, true)}} widgetDimensions="20px" svgIconViewBoxes="0 0 32 32" widgetSpacings="0px"
